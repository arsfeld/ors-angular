...
###
angular.module("session.services", ["config", "log", "ds", "flash"]).factory "session", ["config", "flash", "log", "ds", "$location", "$rootScope", "$route", (config, flash, log, ds, $location, $rootScope, $route) ->
