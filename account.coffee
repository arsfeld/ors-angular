...
###
angular.module("account.controllers.main", ["config", "flash", "user"]).controller "AccountMainCtrl", ["$scope", "config", "flash", "$location", "$timeout", "user", "session", "account.providers", ($scope, config, flash, $location, $timeout, user, session, providers) ->
